...
def create_plot(scores, boxes, im_file):
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'var/www/downloads/json/{}.json'.format(os.path.splitext(os.path.basename(im_file))[0])), 'w') as outfile:  
